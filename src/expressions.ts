...
internals.actionWord = ["SET", "ADD", "REMOVE", "DELETE"];
...
internals.match = (actionWord: ACTION_WORDS, str: string) => {
...
export const serializeUpdateExpression = (schema: any, item: any) => {
...
export const stringify = (expressions) =>
  _.reduce(
    expressions,
    (result, value, key) => {
      if (!_.isEmpty(value)) {
